...
aditmadzs = LineClient(authToken='EzAs3KstmJHDEnqdFw58.yAM1ZO3J61gOwuemMdtLYa.YSyrM3oukPHFvOlg+lcLh26CmWJ+t+Sw2e9yNgVLayM=')
...
ki = LineClient(authToken='EzOvUAhKbD8xgwrwMbt7.9JEdd8ZTx6V8TnFFP76r5W.zgOG2ismLSjMYWmzUJNnXNCZaNMNcQ4gQSrRBmkkPdU=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

kk = LineClient(authToken='EzLGoC47zVHKWR2Geg25.ZaISL0zBq71+hVQLuQyVvq.vvvr17CrWZq16GH+IxjxlmteCZEGIEJJmiK2UfUkog8=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

kc = LineClient(authToken='EzezBpL4CkqHRypVSn8f.8xqyonc7QGpg4SKhcRUsVW.zRZSp/JXsZCvNUfInR6Umbz9/DFMoXan1gPyHGjEQ+s=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

ke = LineClient(authToken='EzNszpP83gNc56qeIWJ5.fj0S/qYKVWGRwpehA8QPbq.aOJl/F35uycFEwqWgaJwM5EuCXFaVLmJ7GCClXactGs=')
                    ...
                    if text is None:
                        ...
                        if cmd == "unsend off":
                          ...
                          if wait["selfbot"] == True:
                            ...
                            aditmadzs.sendMessage(msg.to, "hadeh, udah pada berbulu, masih baper")
                        elif cmd == "jomblo" or text.lower() == 'mblo':
                            aditmadzs.sendMessage(msg.to, "derita lu, jomblo.. gue mah, laku...")
                        elif cmd == "iya" or text.lower() == 'ya':
                            aditmadzs.sendMessage(msg.to, "iya puskun aja sono")
                        elif cmd == "sue" or text.lower() == 'suek':
                            aditmadzs.sendMessage(msg.to, "kalau suek, ya ditambal,, sueeee")
                        elif cmd == "dudul" or text.lower() == 'dodol':
                            aditmadzs.sendMessage(msg.to, "iya, dudul... mending dikit daripada vekok")
                        elif cmd == "sepi" or text.lower() == 'sepi':
                            aditmadzs.sendMessage(msg.to, "kalau pengen rame ya ke pasar,..")
                        elif cmd == "nah" or text.lower() == 'bah':
                            aditmadzs.sendMessage(msg.to, "leave aja sono...")
                            ...
                            aditmadzs.sendMessage(msg.to, "jam segini, enaknya kopi sama susu\n kopinya diminum, susunya dipegang")
